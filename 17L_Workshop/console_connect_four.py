...
def travel_direction(coordinates, current_row, current_col, element, board):    # sign
    count = 0
...
def is_winner(current_row_index, current_col_index, board):
    for direction, coords in DIRECTION_MAPPER.items():
        ...
        # travel_direction_count = travel_direction(coords, current_row_index, current_col_index, searched_element, sign = "+", board)
        # travel_opposite_direction_count = travel_opposite_direction(coords, current_row_index, current_col_index,
        #                                                             searched_element, sign = "-", board)
...
def is_board_full(turns):      # def is_board_full(board):
