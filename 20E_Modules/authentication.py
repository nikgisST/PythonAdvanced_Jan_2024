...
from tkinter import Button  # mac from tkmacosx import Button
...
def get_users_data():
    ...
    with open("db/users_information.txt", "r") as users_file:
        for line in users_file:
            info_data.append(loads(line))           # loads от string (.txt) към dictionary
...
password_box = Entry(root, bd=0, show="*")        # show = "*"   PostHog
