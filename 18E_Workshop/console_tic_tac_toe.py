...
def choose_position():
    ...
    while True:
        try:
            ...
            continue    # за да има отново избор да избере позиция
...
def start():
    ...
    while True:
        ...
        if player_one_symbol not in ["X", "O"]:
            ...
            break     # ако избере правилния знак, приключва функцията

    player_two_symbol = "O" if player_one_symbol == "X" else "X"  # ако нещото е истина се връща оператора вляво ако е лъжа в дясно
