print([x for x in range(100) if all(x % y != 0 for y in range(2, x))])  # връща вс прости числа
...
def eat_cookie(presents_left: int, nice_kids: int) -> tuple[int or Any, int]:  # създаваме фунцкия, първи параметър останалите подаръци и втори добрите деца
