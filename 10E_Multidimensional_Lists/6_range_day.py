...
def move(direction: str, steps: int) -> List[int]:  # създаваме фунцкия move, първи параметър посоката и втори стъпките int
...
def shoot(direction: str) -> List[int] or None: # създаваме фунцкия shoot, параметър посоката на стрелба
